    ...
    <div className='registeration'>
        ...
        <form onSubmit={handleSubmit} className="registerationForm">
            ...
            <TextField 
                        ...
                        onChange={handleFormChange}
            /> 
            <TextField label="Branch" size='small' name = "branch" select value = {form.branch} fullWidth onChange={handleFormChange} required>
                {
                    branch.map((branchName)=>{
                        return (
                            <MenuItem value = {branchName} key={branchName}>{branchName}</MenuItem>
                        )
                    })
                }
                
            </TextField>
            <TextField label="section" size='small' name = "section" select value = {form.section} fullWidth onChange={handleFormChange} required>
                {
            ...
            <TextField label="year" size='small' name = "year" select value = {form.year} fullWidth onChange={handleFormChange} required>
                {
                    years.map((item)=>{
                        return (
            ...
            />
            <br/><br/>
            <Button variant='contained' type='submit' id="register">REGISTER</Button>
            <br/><br/>
        </form>
